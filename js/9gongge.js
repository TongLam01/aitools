...
严禁改变人物身份，九宫格内必须是同一个人，脸型五官、发型、服装材质与颜色、拍摄角度与距离必须保持高度一致。严禁出现页头文本或标题。禁止使用复杂背景，禁止男性化姿态，禁止恐怖或悲伤表情。`,
    ...
    couple: `一张包含 3x3 九宫格矩阵的男女双人摄影图像，比例为 1:1。

【视觉风格与主题】
极简新年马年男女情侣风格。以马年新年祝福语作为背景装饰元素，每格画面仅出现一组核心祝福词，排版留白充足，文字作为辅助装饰，不遮挡人物面部或互动区域。整体氛围自然、温馨、有生活感。

【主体人物描述】
九宫格内必须始终为男女各一人，是同一对年轻的亚洲情侣，保持高度的人物一致性。
★重要：参考图为双人合影拼接图，左侧为男性，右侧为女性。请严格对应生成。
- 女性（画面右侧）：身穿简约现代的红色针织一字领毛衣，妆容清透自然。
- 男性（画面左侧）：身穿低饱和度的红色或米白色针织毛衣，肤感干净自然。
两人呈现自然亲密的情侣关系，表情基调为开心、放松，带有默契的微笑。

【九宫格详细动作与文字配置】
1. 第一格：一男一女并肩站立，身体微靠，手拿节日装饰棒，自然对视微笑。背景文字：「Happy Horse Year」「新年好」。
2. 第二格：一男一女同时做出贴脸手势，头部轻微靠近。背景文字：「马年大吉」「Ho Se 发财」。
3. 第三格：男女两人中的一人手举“福”字牌，另一人温柔注视对方。背景文字：「马到成功」「2026」。
4. 第四格：男女两人并排坐姿，肩膀轻触，手拿红包，同时看镜头微笑。背景文字：「一马当先」「一起向前」。
5. 第五格（中心位）：男女两人站立居中，背景色微调为浅红色，自然牵手，手拿红包。背景文字：「2026 马年大吉」。
6. 第六格：男女两人以轻松玩闹的姿态，手拿红包，一人看镜头，一人看对方。背景文字：「Happy 2026」「NEW YEAR」。
7. 第七格：男女两人身体向同一侧微倾，手拿节日装饰棒，动作同步且默契。背景文字：「喜气」「Happy New Year」。
8. 第八格：男女两人中的一人做举拳拜年状，另一人微笑看向对方，佩戴节日头饰。背景文字：「马到成功」。
9. 第九格：两人两人站立贴近，手拿福气球，同时看镜头，充满幸福感。背景文字：「Ho Se 发财」「Happy New Year」。

【核心要求与约束】
九宫格内的两个人物必须是一男一女，两个角色的外貌和服装必须全程保持一致，不得更换人物身份，禁止同时出现两个男性或女性。拍摄角度与光影需和谐统一，呈现出高质量的摄影质感。禁止出现页头文本或标题。避免刻意的表演感，强调情侣间真实的眼神交流与温柔笑意。`
};
