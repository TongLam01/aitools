...
【九宫格详细动作与文字配置】
1. 第一格：一男一女并肩站立，手拿节日装饰棒。背景文字：「Happy Horse Year」「新年好」。
2. 第二格：一男一女同时做出贴脸手势。背景文字：「马年大吉」「Ho Se 发财」。
3. 第三格：一男一女，一人手举“福”字牌，另一人注视对方。背景文字：「马到成功」「2026」。
4. 第四格：一男一女并排坐姿，手拿红包。背景文字：「一马当先」「一起向前」。
5. 第五格（中心位）：一男一女牵手站立，背景浅红。背景文字：「2026 马年大吉」。
6. 第六格：一男一女手拿红包，一人看镜头，一人看对方。背景文字：「Happy 2026」「NEW YEAR」。
7. 第七格：一男一女身体微倾，动作同步。背景文字：「喜气」「Happy New Year」。
8. 第八格：一男一女，一人举拳拜年，一人微笑。背景文字：「马到成功」。
9. 第九格：一男一女贴近，手拿福气球。背景文字：「Ho Se 发财」「Happy New Year」。

【核心要求与约束】
画面中必须始终存在一男一女。严禁出现两个男性或两个女性。利用提供的多张参考图特征，准确还原男女服装（男白女红）和发型差异。`
};
