...
【九宫格详细动作与文字配置（身份强化版）】
1. 第一格：[男左女右] 左侧米衣男性与右侧红衣女性并肩站立，身体微靠，共同手拿节日装饰棒，对视微笑。背景文字：「Happy Horse Year」「新年好」。
2. 第二格：[男左女右] 左侧男性与右侧女性同时做出贴脸手势，头部向中间轻微靠近，笑容甜蜜。背景文字：「马年大吉」「Ho Se 发财」。
3. 第三格：[男左女右] 左侧男性手举红色的“福”字牌，右侧女性侧头温柔注视男性。背景文字：「马到成功」「2026」。
4. 第四格：[男左女右] 两人并排坐姿，左侧男性肩膀轻触右侧女性，两人共同拿着一个大红包，看镜头微笑。背景文字：「一马当先」「一起向前」。
5. 第五格（中心位）：[男左女右] 两人站立居中，左侧男性牵着右侧女性的手，女性另一只手拿红包。背景色微调为浅红色。背景文字：「2026 马年大吉」。
6. 第六格：[男左女右] 轻松玩闹姿态，右侧女性拿着红包挡脸偷笑，左侧男性宠溺地看着她。背景文字：「Happy 2026」「NEW YEAR」。
7. 第七格：[男左女右] 身体向同一侧微倾，左侧男性和右侧女性动作同步拿着装饰棒，默契十足。背景文字：「喜气」「Happy New Year」。
8. 第八格：[男左女右] 左侧男性做举拳拜年状，右侧女性佩戴节日小头饰，微笑着看向男性。背景文字：「马到成功」。
9. 第九格：[男左女右] 两人站立贴近，共同捧着一个金色的福气球，看着镜头，充满幸福感。背景文字：「Ho Se 发财」「Happy New Year」。

【核心要求与约束】
每一格画面中必须严格保持一男一女，且左男右女站位不变。严禁出现两个男性或两个女性。男女双方的服装颜色（男米白、女红）和发型必须全程保持一致，不得混淆身份。拍摄角度与光影需和谐统一，呈现出高质量的摄影质感。`
};
